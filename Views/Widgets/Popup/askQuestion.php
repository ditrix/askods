    ...
    <div class="mfiModal__content">
        <div class="bottom_form__block">
            <div class="wTitle w_tac">
                <p class="middle_title"><!-- был заголовок отзыва на вакансию -->
                <span><?php echo __('У вас возникли вопросы или вы хотите оставить отзыв?');?></span>
                </p>
            </div>
            <span><?php //echo __('У вас возникли вопросы или вы хотите оставить отзыв?');?></span>
            <span><?php echo __('Заполните поля формы для обратной связи'); //echo nl2br(\Core\Config::get('static.label_form_response_to_job')); ?></span>
            <!--<div data-form="true" class="wForm wFormDef" data-ajax="respondToJob">-->
            <div data-form="true" class="wForm wFormDef" data-ajax="askQuestion">
                <div class="wFormRow">
